...
class Inception(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.use_auxiliary:
            outputs, aux1, aux2 = self.forward(inputs)
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.all_predictions.extend(predicted.tolist())
        return outputs, predicted, labels

    def on_test_end(self):
        print(classification_report(y_true=self.all_labels, y_pred=self.all_predictions))
